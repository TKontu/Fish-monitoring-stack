...
<html>
	...
	<body>
		<div class="register">
            ...
            <p class="logintext">
            <b>Recovery code can be found in registration email.</b>
            </p>
            <div>
				<?php
			...
			<form action="./php/recover.php" method="post" autocomplete="off">
				<label for="username">
				...
				<input type="text" name="recoverycode" placeholder="recoverycode" id="recoverycode" required>
